...
const Footer = () => {
  return(
    ...
    <div className="container">
      ...
      <p className="small">All images and gifs are not mine. All media sources are written in the page source. (Right Click and Click 'View Page Source'.) All credits to the respective owners.</p>
    </div>
    </footer>
  );
};
